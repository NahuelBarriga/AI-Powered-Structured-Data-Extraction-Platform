...
export const OrderItemSchema = z.object({
  ...
  modifiers: z.string().nullable().describe("Customizations or modifiers for the item (e.g. no sugar, extra milk)."),
});
...
export const OrderSchema = z.object({
  ...
  notes: z.string().nullable().describe("Additional order notes or instructions."),
});
